...
# === CONFIGURATION ===
st.set_page_config(page_title="T.I.T.A.N. (Threat Intelligence & Tactical Attribution Network)", layout="wide", page_icon="🛡️")
...
class ForensicReport(FPDF):
    def header(self):
        if PDF_AVAILABLE: # Evita errori se FPDF non è reale
            ...
            self.cell(0, 10, 'T.I.T.A.N. - Automated Forensic Attribution Report', 0, 1, 'C')
...
def create_full_technical_report(df_results, meta_info):
    ...
    pdf.cell(0, 10, 'T.I.T.A.N. (Threat Intelligence & Tactical Attribution Network)', 0, 1, 'C')
...
st.title("T.I.T.A.N. (Threat Intelligence & Tactical Attribution Network)")
